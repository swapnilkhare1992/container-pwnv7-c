...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-pwnv7-c.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-pwnv7-c.containers.anotherwebservice.com/
...
```
git clone git@github.com:swapnilkhare1992/container-pwnv7-c.git
cd container-pwnv7-c
```
...
```
docker attach container-pwnv7-c
```
